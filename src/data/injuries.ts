...
import type {
  InjuryResult,
  CriticalHitEffect,
  HenchmanSeriousInjuryResult,
  HeroSeriousInjuryResult,
...
export const INJURY_RESULTS: Record<number, InjuryResult> = {
...
export const CRITICAL_HIT_TABLE: Record<number, CriticalHitEffect> = {
...
export const HENCHMAN_SERIOUS_INJURY: Record<number, HenchmanSeriousInjuryResult> = {
...
export const HERO_SERIOUS_INJURIES: Record<number, HeroSeriousInjuryResult> = {
...
export const EXPERIENCE_THRESHOLDS: ExperienceThresholds = {
...
export const HERO_ADVANCE_TABLE: Record<number, HeroAdvance> = {
...
export const HENCHMAN_ADVANCE_TABLE: Record<number, HenchmanAdvance> = {
...
export const UNDERDOG_BONUS: UnderdogBonus[] = [
