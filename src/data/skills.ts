...
import type { Skills, SkillCategories, SkillTables, SkillCategory } from '../types';
...
// Skill availability by warrior type (simplified)
export const SKILL_TABLES: SkillTables = {
