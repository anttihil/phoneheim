...
import type { Scenario, ScenarioTable, PreBattleSequence } from '../types';
...
export const SCENARIO_TABLE: ScenarioTable = {
...
// Pre-battle sequence
export const PRE_BATTLE_SEQUENCE: PreBattleSequence = [
