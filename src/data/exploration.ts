...
export const WYRDSTONE_FOUND: WyrdstoneFoundRange[] = [
...
export const EXPLORATION_DOUBLES: ExplorationDoubles = {
  11: {
    name: 'Well',
...
export const EXPLORATION_TRIPLES: ExplorationTriples = {
  111: {
    name: 'Tavern',
...
export const EXPLORATION_QUADS: ExplorationQuads = {
  1111: {
    name: 'Gunsmith',
...
export const EXPLORATION_FIVE: ExplorationFive = {
  11111: {
...
export const EXPLORATION_SIX: ExplorationSix = {
  111111: {
    name: 'The Pit',
...
export const POST_BATTLE_SEQUENCE: PostBattleSequence = [
...
export function calculateWarbandRating(warband: Warband): number {
  let rating = 0;
